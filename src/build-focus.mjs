...
const history=readFileSync(new URL('./historical.mjs',import.meta.url),'utf8').replace(/^import .*$/gm,'').replace(/^export /gm,'');
const worker=`// Generated v41: focused migration collector and cached source balance.
${collector}
${history}
